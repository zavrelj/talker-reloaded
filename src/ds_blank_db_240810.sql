...
-- Vygenerováno: Pátek 05. března 2010, 14:32
-- Verze MySQL: 5.1.37
-- Verze PHP: 5.2.6
-- 
-- Databáze: `janzavjcb137cz1044_g3nus`
-- 

-- --------------------------------------------------------

-- 
-- Struktura tabulky `g3nus_friends`
-- 

DROP TABLE IF EXISTS `ds_friends`;
...
INSERT INTO `ds_logs` (`FK_user`, `log_time`, `log_IP`, `log_host`, `log_agent`) VALUES (2, 1267795293, '193.165.208.194', '', 'Mozilla/5.0 (Windows; U; Windows NT 6.1; en-US) AppleWebKit/532.5 (KHTML, like Gecko) Chrome/4.0.249');
...
DROP TABLE IF EXISTS `ds_room_banned_writers`;
...
DROP TABLE IF EXISTS `ds_room_deniers`;
...
DROP TABLE IF EXISTS `ds_room_keepers`;
...
DROP TABLE IF EXISTS `ds_room_viewers`;
...
DROP TABLE IF EXISTS `ds_rooms_access`;
...
DROP TABLE IF EXISTS `ds_rooms_bookmarks`;
...
DROP TABLE IF EXISTS `ds_subtopics`;
...
DROP TABLE IF EXISTS `ds_topics`;
...
INSERT INTO `ds_topics` (`PK_topic`, `topic_name`) VALUES (27, 'G3N.US'),
(1, 'AKTUÁLNĚ'),
(2, 'AUDIO A VIDEO'),
(3, 'CESTOVÁNÍ'),
(4, 'DROGY'),
