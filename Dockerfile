...
##   $ docker build -t php-for-zavrelj-talker-reloaded .
##
## RUNNING
##   $ docker run -p 9000:9000 php-for-zavrelj-talker-reloaded
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="f3h3566" \
    STACKSMITH_STACK_NAME="PHP for zavrelj/talker-reloaded" \
